...
(function (m) {
    var F = function (a) {
        ...
        C = function (a, c, b, j) {
            ...
            this.check = function (c) {
                for (var f = e.length, g = 0, l; -1 < --f;)
                    (l = v[e[f]] || new C(e[f])).gsClass ? d[f] = l.gsClass : (g++, c && l.sc.push(this));
                if (0 === g && b) {
    ...
    for (k = o.length; -1 < --k;)
        d = q("easing." + o[k], function () { }, !0),
            z = q("easing.Power" + k, function () { }, !0),
            d.easeOut = z.easeOut = new s(null, null, 1, k),
            d.easeIn = z.easeIn = new s(null, null, 2, k),
            d.easeInOut = z.easeInOut = new s(null, null, 3, k);
    ...
    d.addEventListener = function (a, c, b, j, e) {
        ...
        for (f = d.length; -1 < --f;)
            a = d[f],
                a.c === c ? d.splice(f, 1) : 0 === h && a.pr < e && (h = f + 1);
        d.splice(h, 0, {
            c: c,
            s: b,
            up: j,
    ...
    d.dispatchEvent = function (a) {
        ...
        if (c)
            for (var b = c.length, j, d = this._eventTarget; -1 < --b;)
                j = c[b],
                    j.up ? j.c.call(j.s || d, {
                        type: a,
                        target: d
    ...
    o = ["ms", "moz", "webkit", "o"];
    for (k = o.length; -1 < --k && !A;)
        A = m[o[k] + "RequestAnimationFrame"],
            B = m[o[k] + "CancelAnimationFrame"] || m[o[k] + "CancelRequestAnimationFrame"];
    B || (B = function (a) {
        m.clearTimeout(a)
    });
    q("Ticker", function (a, c) {
        ...
        this.tick = function () {
            ...
            if (!i || b.time >= l)
                b.frame++,
                    l = b.time + g - (b.time - l) - 5E-4,
                    l <= b.time && (l = b.time + 0.001),
                    b.dispatchEvent("tick");
            f = h(b.tick)
        };
        this.fps = function (a) {
            if (!arguments.length)
        ...
        if ("on" === a.substr(0, 2)) {
            ...
            if (null == c)
                ...
                for (var d = b.length; -1 < --d;)
                    "{self}" === b[d] && (b = this.vars[a + "Params"] = b.concat(), b[d] = this);
    ...
    d.insert = function (a, c) {
        ...
        if (this._sortChildren)
            for (var d = a._startTime; b && b._startTime > d;)
                b = b._prev;
    ...
    d.render = function (a, c) {
        ...
        for (this._totalTime = this._time = this._rawPrevTime = a; b;) {
            d = b._next;
            if (b._active || a >= b._startTime && !b._paused)
                b._reversed ? b.render((!b._dirty ? b._totalDuration : b.totalDuration()) - (a - b._startTime) * b._timeScale, c, !1) : b.render((a - b._startTime) * b._timeScale, c, !1);
            b = d
        }
    };
    d.rawTime = function () {
    ...
    var g = q("TweenLite", function (a, c, b) {
        ...
        if ((a instanceof Array || a.jquery) && "object" === typeof a[0]) {
            ...
            for (a = 0; a < this._targets.length; a++)
                b = this._targets[a],
                    b.jquery ? (this._targets.splice(a--, 1), this._targets = this._targets.concat(b.constructor.makeArray(b))) : (this._siblings[a] = x(b, this, !1), 1 === this._overwrite && 1 < this._siblings[a].length && E(b, this, null, 1, this._siblings[a]))
        } else
            this._propLookup = {},
                this._siblings = x(a, this, !1),
                1 === this._overwrite && 1 < this._siblings.length && E(a, this, null, 1, this._siblings);
    ...
    var x = function (a, c, b) {
        ...
        E = function (a, c, b, d, e) {
            ...
            var g = c._startTime + 1E-10,
                ...
                m;
            for (i = e.length; -1 < --i;)
                if (!((f = e[i]) === c || f._gc || f._paused))
                    f._timeline !== c._timeline ? (m = m || L(c, 0), 0 === L(f, m) && (l[k++] = f)) : f._startTime <= g && f._startTime + f.totalDuration() / f._timeScale + 1E-10 > g && ((0 === c._duration || !f._initted) && 2E-10 >= g - f._startTime || (l[k++] = f));
            for (i = k; -1 < --i;)
                if (f = l[i], 2 === d && f._kill(b, a) && (h = !0), 2 !== d || !f._firstPT && f._initted)
                    f._enabled(!1, !1) && (h = !0);
            return h
        },
        L = function (a, c) {
    ...
    d._init = function () {
        ...
        if (this._targets)
            for (a = this._targets.length; -1 < --a;) {
                if (this._initProps(this._targets[a], this._propLookup[a] = {}, this._siblings[a], this._overwrittenProps ? this._overwrittenProps[a] : null))
                    c = !0
            }
        else
            c = this._initProps(this.target, this._propLookup, this._siblings, this._overwrittenProps);
        ...
        for (e in this.vars) {
            if (N[e]) {
                if ("onStartParams" === e || "onUpdateParams" === e || "onCompleteParams" === e || "onReverseCompleteParams" === e || "onRepeatParams" === e)
                    if (g = this.vars[e])
                        for (i = g.length; -1 < --i;)
                            "{self}" === g[i] && (g = this.vars[e] = g.concat(), g[i] = this)
                ...
                for (i = f._overwriteProps.length; -1 < --i;)
                    c[f._overwriteProps[i]] = this._firstPT;
                if (f._priority || f._onInitAllProps)
                    h = !0;
                if (f._onDisable || f._onEnable)
                ...
                this._firstPT = c[e] = l = {
                    ...
                    l.s = !l.f ? parseFloat(a[e]) : a[e.indexOf("set") || "function" !== typeof a["get" + e.substr(3)] ? e : "get" + e.substr(3)](),
                    i = this.vars[e],
                    l.c = "number" === typeof i ? i - l.s : "string" === typeof i && "=" === i.charAt(1) ? parseInt(i.charAt(0) + "1") * Number(i.substr(2)) : Number(i) || 0;
    ...
    d.render = function (a, c, b) {
        ...
        if (a >= this._duration) {
            if (this._totalTime = this._time = this._duration, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (e = !0, i = "onComplete"), 0 === this._duration) {
                if (0 === a || 0 > this._rawPrevTime)
                    this._rawPrevTime !== a && (b = !0);
                this._rawPrevTime = a
            }
        } else if (0 >= a) {
            this._totalTime = this._time = 0;
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0;
            if (0 !== d || 0 === this._duration && 0 < this._rawPrevTime)
                i = "onReverseComplete",
                    e = this._reversed;
        ...
        if (this._time !== d || b) {
            ...
            if (0 === d && this.vars.onStart && (0 !== this._time || 0 === this._duration))
                c || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || D);
            for (a = this._firstPT; a;) {
                if (a.f)
    ...
    d._kill = function (a, c) {
        "all" === a && (a = null);
        if (null == a && (null == c || c == this.target))
            return this._enabled(!1, !1);
            ...
            if (i)
                for (e in f = a || i, k = a != d && "all" != d && a != i && (null == a || !0 != a._tempKill), f) {
                    if (b = i[e]) {
                        ...
                        if (!b.pg || 0 === b.t._overwriteProps.length)
                            b._prev ? b._prev._next = b._next : b === this._firstPT && (this._firstPT = b._next),
    ...
    d._enabled = function (a, c) {
        if (a && this._gc)
            if (this._targets)
                for (var b = this._targets.length; -1 < --b;)
                    this._siblings[b] = x(this._targets[b], this, !0);
            else
    ...
    g.killTweensOf = g.killDelayedCallsTo = function (a, c) {
        for (var b = g.getTweensOf(a), d = b.length; -1 < --d;)
            b[d]._kill(c, a)
    };
    ...
    d._kill = function (a) {
        if (null != a[this._propName])
            ...
            for (var c = this._overwriteProps.length; -1 < --c;)
                null != a[this._overwriteProps[c]] && this._overwriteProps.splice(c, 1);
        for (c = this._firstPT; c;)
            null != a[c.n] && ((c._next && (c._next._prev = c._prev), c._prev) ? (c._prev._next = c._next, c._prev = null) : this._firstPT === c && (this._firstPT = c._next)),
                c = c._next;
        return !1
    };
    d._roundProps = function (a, c) {
        for (var b = this._firstPT; b;) {
            if (a[this._propName] || null != b.n && a[b.n.split(this._propName + "_").join("")])
                b.r = c;
            b = b._next
        }
    };
    g._onPluginEvent = function (a, c) {
        ...
        for (; b;)
            b.pg && "function" === typeof b.t[a] && b.t[a]() && (d = !0),
                b = b._next;
        return d
    };
    y.activate = function (a) {
        for (var c = a.length; -1 < --c;)
            a[c].API === y.API && (g._plugins[(new a[c])._propName] = a[c]);
        return !0
    };
    if (o = m._gsQueue) {
        for (k = 0; k < o.length; k++)
            o[k]();
        for (d in v)
            v[d].def || console.log("Warning: TweenLite encountered missing dependency: com.greensock." + d)
    }
})(window);
